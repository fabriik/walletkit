...
DEFINE_NETWORK (CRYPTO_NETWORK_TYPE_XLM,  "stellar-mainnet", NETWORK_NAME, "mainnet", true, 35516170, 1, 5)
...
DEFINE_ADDRESS_SCHEMES  ("stellar-mainnet", CRYPTO_ADDRESS_SCHEME_NATIVE)
DEFINE_MODES            ("stellar-mainnet", CRYPTO_SYNC_MODE_API_ONLY)
#if HAS_XLM_TESTNET
DEFINE_NETWORK (CRYPTO_NETWORK_TYPE_XLM,  "stellar-testnet", NETWORK_NAME, "testnet", false, 1075721, 1, 5)
...
DEFINE_UNIT ("stellar-testnet:__native__",  "lumen_i",     "xlm_i",   0,  "XLM_I")
DEFINE_UNIT ("stellar-testnet:__native__",  NETWORK_NAME,  "xlm",     7,  "XLM")
DEFINE_ADDRESS_SCHEMES  ("stellar-testnet", CRYPTO_ADDRESS_SCHEME_NATIVE)
