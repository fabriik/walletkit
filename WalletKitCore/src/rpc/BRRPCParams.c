...
#include "BRRPCParams.h"

static const char *BRRPCMainNetDNSSeeds[] = {
...
static const char *BRRPCTestNetDNSSeeds[] = {
...
static const BRCheckPoint BRRPCMainNetCheckpoints[] = {
...
//TODO: Need to revise these for the BitcoinRPC regtest
static const BRCheckPoint BRRPCTestNetCheckpoints[] = {
    ...
    {  100, uint256("0000000000a33112f86f3f7b0aa590cb4949b84c2d9c673e9e303257b3be9000"), 1376543922, 0x1c00d907 },
    ...
    { 1814400, uint256("00000000020eb7b7cf624cf5476bdfce5b2b5d0bd82b420ca8912c54cda3ac31"), 1598344460, 0x1c03fffc },
    //{ 1915200, uint256("000000000000317a7b535ead7a8f38ef50ee47d3dbf8f5e8597085bf22049dc5"), 1612165617, 0x1c00d3c7 }
    { 100, uint256("000000000000317a7b535ead7a8f38ef50ee47d3dbf8f5e8597085bf22049dc5"), 1612165617, 0x1c00d3c7 }
    // 2016000
};

static int BRRPCMainNetVerifyDifficulty(const BRMerkleBlock *block, const BRSet *blockSet)
{
...
static int BRRPCTestNetVerifyDifficulty(const BRMerkleBlock *block, const BRSet *blockSet)
{
    return 1; // XXX skip testnet difficulty check for now
}

extern const BRCheckPoint *BRRPCChainParamsGetCheckpointBefore (const BRChainParams *params, uint32_t timestamp) {
...
extern const BRCheckPoint *BRRPCChainParamsGetCheckpointBeforeBlockNumber (const BRChainParams *params, uint32_t blockNumber) {
    for (ssize_t index = (ssize_t) (params->checkpointsCount - 1); index >= 0; index--)
...
static const BRChainParams BRRPCParamsRecord = {
    BRRPCMainNetDNSSeeds,
    8333,                  // standardPort
    0xd9b4bef9,            // magicNumber
    SERVICES_NODE_WITNESS, // services
    BRRPCMainNetVerifyDifficulty,
    BRRPCMainNetCheckpoints,
    sizeof(BRRPCMainNetCheckpoints)/sizeof(*BRRPCMainNetCheckpoints),
    { BITCOIN_PUBKEY_PREFIX, BITCOIN_SCRIPT_PREFIX, BITCOIN_PRIVKEY_PREFIX, BITCOIN_BECH32_PREFIX },
    BITCOIN_FORKID
};
const BRChainParams *BRRPCParams = &BRRPCParamsRecord;

static const BRChainParams BRRPCTestNetParamsRecord = {
    BRRPCTestNetDNSSeeds,
    18333,                 // standardPort
    0x0709110b,            // magicNumber
    SERVICES_NODE_WITNESS, // services
    BRRPCTestNetVerifyDifficulty,
    BRRPCTestNetCheckpoints,
    sizeof(BRRPCTestNetCheckpoints)/sizeof(*BRRPCTestNetCheckpoints),
    { BITCOIN_PUBKEY_PREFIX_TEST, BITCOIN_SCRIPT_PREFIX_TEST, BITCOIN_PRIVKEY_PREFIX_TEST, BITCOIN_BECH32_PREFIX_TEST },
    BITCOIN_FORKID
};

const BRChainParams *BRRPCTestNetParams = &BRRPCTestNetParamsRecord;
