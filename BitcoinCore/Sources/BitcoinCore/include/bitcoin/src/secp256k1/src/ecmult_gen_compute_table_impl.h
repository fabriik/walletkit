...
static void secp256k1_ecmult_gen_compute_table(secp256k1_ge_storage* table, const secp256k1_ge* gen, int bits) {
    ...
    secp256k1_ge* prec = (secp256k1_ge*) checked_malloc(&default_error_callback, n * g * sizeof(*prec));
    secp256k1_gej gj;
    ...
    /* compute prec. */
    {
        ...
        secp256k1_gej* precj = (secp256k1_gej*) checked_malloc(&default_error_callback, n * g * sizeof(*precj));  /* Jacobian versions of prec. */
        gbase = gj; /* PREC_G^j * G */
